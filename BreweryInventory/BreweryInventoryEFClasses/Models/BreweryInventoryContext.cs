...
public partial class BreweryInventoryContext : DbContext
{
    public BreweryInventoryContext()
    {
    }

    public BreweryInventoryContext(DbContextOptions<BreweryInventoryContext> options)
        : base(options)
    {
    }
